<div class="pg-widget">
  ...
  <div class="cpn-crumbs">
    <ul class="cpn-crumbs__list">
      ...
      <li class="cpn-crumbs__list-item"><a href="<?=base_url().'admin/widgets';?>" class="cpn-crumbs__list-item-link">Widgets</a></li>
      <li class="cpn-crumbs__list-item">Le Widget</li>
    </ul>
  </div>
  ...
  <div class="cpn-pg-actions">
    <ul class="cpn-pg-actions__list">
      <li class="cpn-pg-actions__list-item">
        <button class="cpn-pg-actions__list-item-btn" data-bs-toggle="modal" data-bs-target="#newWidgetElem">
          <i class="icon-plus"></i>
          <span class="text">Nouveau Element</span>
        </button>
      </li>
    </ul>
  </div>
