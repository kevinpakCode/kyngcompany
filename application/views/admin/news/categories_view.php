<div class="pg-news">
  ...
  <div class="cpn-crumbs">
    <ul class="cpn-crumbs__list">
      ...
      <li class="cpn-crumbs__list-item">Les catégories d'Actualités</li>
    </ul>
  </div>
  ...
  <div class="cpn-pg-actions">
    <ul class="cpn-pg-actions__list">
      <li class="cpn-pg-actions__list-item">
        <button class="cpn-pg-actions__list-item-btn" data-bs-toggle="modal" data-bs-target="#newCategory">
          <i class="icon-plus"></i>
          ...
          <tr>
              ...
              <div class="cpn-tbl-item">
                <div class="cpn-tbl-item__inner">
                  ...
                  <div class="cpn-tbl-item__infos">
                    <div class="cpn-tbl-item__infos-row cpn-tbl-item__infos-row--name">Sport</div>
                  </div>
                </div>
              </div>
            </td>
            ...
            <td class="cpn-table__actions cpn-table__actions--right">
              <div class="cpn-table__actions-btns">
                ...
                <button class="cpn-table__actions-item" title="Modifier les informations" data-bs-toggle="modal" data-bs-target="#newCategory"><i class="icon-edit"></i></button>
              </div>
            </td>
          </tr>
